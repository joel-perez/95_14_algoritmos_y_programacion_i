Program ContableEmpresarialInternacional;
 ...
 Procedure CuadroVentasArg2015(Var ArchVentasArg:T_ArchVentasArg; Var ArchSucArg:T_ArchSucArg);
   ...
   Function ConversionEntero(VentasSuc[MesPpal]:real):longword;
     Const
       Coma=',';
       Inicial=1;
     Var
 ...
 Procedure ActualizarVentasHistorico(Var ArchVentasArg:T_ArchVentasArg; Var ArchVentasHistorico:T_ArchVentasHistorico; Var ArchVentasHistoricoActualizado:T_ArchVentasHistorico);
  ...
  Procedure LecturaConversionArchVentasArg(Var ArchVentasArg:T_ArchVentasArg; Var RegVentasArgH:T_RegVentasHistorico; Var FinVentasArg:boolean; Var RegVentasArg:T_RegVentasArg);
  ...
  Begin{Local de ProcedureActualizarVentasHistorico}
    ...
    if (not FinVentasArg) then
      begin
        LecturaArchVentasArg(ArchVentasArch, RegVentasArg, FinVentasArg);
        LecturaConversionArchVentasArg(ArchVentasArg, RegVentasArgH, FinVentasArg, RegVentasArg)
      end; 
            ...
            begin
              ...
              LecturaArchVentasHistorico(ArchVentasHistorico, RegVentasHistorico, FinVentasHistorico);
                ...
                if (RegVentasArgH.Importe<>0) then
                  ...
                  else LecturaConversionArchVentasArg(ArchVentasArg, RegVentasArgH, FinVentasArg, RegVentasArg)
               end;
      end;
